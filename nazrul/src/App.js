...
// import HariRayaPopup from './components/HariRayapopup'; // Make sure the path is correct
...
//   const [showRaya, setShowRaya] = useState(false);
  
//   return (
//     <div className={`app ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
// <Header openRayaPopup={() => setShowRaya(true)} />
// <HariRayaPopup show={showRaya} onClose={() => setShowRaya(false)} />
...
import { BrowserRouter as Router, Route, Routes } from 'react-router-dom';
import Header from './components/header';
import HariRayaPopup from './components/HariRayapopup';
import MainContent from './components/body';
import Footer from './components/footer';
import About from './components/about';
import Services from './components/services';
import ReturnFlights from './components/return';
...
function AppContent() {
  ...
  const [showRaya, setShowRaya] = useState(false); // controls popup
    ...
    <div className={`app ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <main>
        <Routes>
          ...
          <Route path="/Hotelpaymentdone" element={<HotelPaymentDone />} />
