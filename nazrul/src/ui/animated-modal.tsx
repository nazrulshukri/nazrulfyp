...
export const ModalTrigger: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
...
export const ModalBody: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
  ...
  // This hook should be used unconditionally
  useEffect(() => {
    document.body.style.overflow = open ? "hidden" : "auto";
  }, [open]);

  // Ensure `useOutsideClick` is called at the top level
...
// Ensure this hook is always used the same way
